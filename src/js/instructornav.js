function  createNav(){
    var holder =""
        ...
        holder +=
        `<nav id="menu" class="top-0 hidden md:block  z-50 md:z-0 w-[80%] md:w-60  h-screen  fixed  bg-[#2F4858]  transition-all  duration-1000 ease-in-out delay-300 overflow-y-scroll ">
